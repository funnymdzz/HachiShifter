    ...
    state.clips = timeline.clips.map((clip: TimelineClip) => {
        const parsed = {
            ...
            melodyneWarpSegments: clip.melodyne_warp_segments?.map((segment) => ({
                melodyneElementId: segment.melodyneElementId == null ? undefined : Number(segment.melodyneElementId),
                melodyneFollowingElementId: segment.melodyneFollowingElementId == null ? undefined : Number(segment.melodyneFollowingElementId),
                ...
                connectedToClipId: segment.connectedToClipId ?? undefined,
                connectedToElementId: segment.connectedToElementId == null ? undefined : Number(segment.connectedToElementId),
                pitchTransitionSec: Number(segment.pitchTransitionSec ?? 0),
