export const zhCN = {
    ...
    stretch_hifigan_mel: "HiFiGAN 变 Hop Mel 拉伸",
    ...
    stretch_option_melodyne_hybrid: "Melodyne 混合（瞬态保护）",
    stretch_option_loop: "循环拉伸（元音/选区）",
    stretch_option_hifigan_mel_hop: "HiFiGAN 变 Mel Hop 拉伸",
    melodyne_event_lane: "静音 / 呼吸",
    audio_event_silence: "静音",
    audio_event_breath: "呼吸",
    audio_event_none: "未检测到静音或呼吸事件",
    ...
    ctx_edit_sample_timing: "编辑采样分段与音符…",
    sample_timing_title: "采样分段与音符选区",
    sample_timing_description:
        "琥珀色为固定（不拉伸）段，青色为可拉伸段，粉色线为音符对齐点。时间均相对于源音频。",
    sample_timing_analyzing: "正在粗略识别采样边界和音符…",
    sample_timing_redetect: "重新识别",
    sample_timing_import_oto: "导入 oto.ini",
    sample_timing_import_voicebank: "转换整个 UTAU 音源库",
    sample_timing_add_region: "添加选区",
    sample_timing_region: "选区",
    sample_timing_note_count: "已识别 {n} 个音符",
    sample_timing_fixed_segment: "固定／不拉伸段",
    sample_timing_stretch_segment: "可拉伸段",
    sample_timing_alignment: "音符对齐点",
    sample_timing_start: "选区起点",
    sample_timing_fixed_end: "固定段终点",
    sample_timing_end: "选区终点",
    sample_timing_name: "名称／发音",
    sample_timing_fixed_duration: "固定段持续时间",
    sample_timing_active_region: "使用此选区控制当前片段拉伸",
    sample_timing_saved: "CSV 标注已保存并应用到当前片段。",
    sample_timing_detected: "已粗略识别边界与音符，请检查后保存。",
    sample_timing_converting_oto: "正在转换 UTAU oto 标注…",
    sample_timing_oto_result: "已转换 {n} 个采样，产生 {w} 条警告。",
    melodyne_macro_title: "音高校正宏",
    melodyne_macro_selected_scope: "当前选中音符／时间范围",
    melodyne_macro_clip_scope: "整个已选音频片段",
    melodyne_pitch_center: "音高中心",
    melodyne_pitch_drift: "音高漂移",
    melodyne_pitch_modulation: "音高调制",
    melodyne_transition: "过渡时间",
    melodyne_game_model: "GAME 分析模型",
    melodyne_game_large: "高精度 Large",
    melodyne_game_small: "性能 Small",
    melodyne_game_large_hint: "默认使用 Large 模型，获得更精细的音符分割。",
    melodyne_game_small_hint: "性能模式使用 Small 模型，分析速度更快。",
    melodyne_macro_hint: "纵向拖动音符块可移调；校正宏用于保留自然起伏的整体修音。",
    melodyne_reset: "还原",
    melodyne_apply: "应用",
    melodyne_applying: "处理中…",
    melodyne_result: "已使用 {detector} 校正 {n} 个音符。",
    melodyne_show_macro: "校正宏",
    melodyne_wrench_title: "音符工具",
    melodyne_note_lane: "音符选区",
    melodyne_segment_lane: "采样分段",
    ...
    melodyne_compose_select_description: "Compose 轨道会还原 Melodyne 音符对象并使用 MLD5 处理；其余轨道作为普通音轨，不进行音高分析和修音。",
    melodyne_processing_order: "处理顺序",
    melodyne_note_first: "先修音和拉伸，后拼接",
    melodyne_note_first_hint: "UTAU 式：先处理每个发音，再组装成完整轨道。",
    melodyne_track_first: "先拉伸拼接，后修音",
    melodyne_track_first_hint: "DAW 式：先组装完整轨道，再跨采样进行整体音高处理。",
    melodyne_import_continue: "导入工程",
    melodyne_pitch_source: "原始音高线来源",
    melodyne_pitch_source_project: "Melodyne 工程（高精度）",
    melodyne_pitch_source_project_hint: "严格读取工程保存的原始音高点、时间映射和修改参数，不再分析覆盖。",
    melodyne_pitch_source_game_fcpe: "GAME + FCPE 重新识别",
    melodyne_pitch_source_game_fcpe_hint: "用 GAME 识别音节、FCPE 提取素材音高线，再应用工程中的目标音高偏移。",
    melodyne_consonant_length: "辅音 / 起音长度",
