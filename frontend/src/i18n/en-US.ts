export const enUS = {
    ...
    stretch_hifigan_mel: "HiFiGAN Variable-hop Mel Stretch",
    ...
    stretch_option_melodyne_hybrid: "Melodyne Hybrid (transient-aware)",
    stretch_option_loop: "Loop Stretch (vowel/selection)",
    stretch_option_hifigan_mel_hop: "HiFiGAN Variable-hop Mel",
    melodyne_event_lane: "Silence / Breath",
    audio_event_silence: "Silence",
    audio_event_breath: "Breath",
    audio_event_none: "No silence or breath events detected",
    ...
    ctx_edit_sample_timing: "Edit Sample Timing…",
    sample_timing_title: "Sample Timing and Note Regions",
    sample_timing_description:
        "Amber is the fixed (non-stretched) segment, cyan is stretchable, and pink is the note alignment point. Times are relative to the source audio.",
    sample_timing_analyzing: "Analyzing sample boundaries and notes…",
    sample_timing_redetect: "Detect Again",
    sample_timing_import_oto: "Import oto.ini",
    sample_timing_import_voicebank: "Convert Voicebank Folder",
    sample_timing_add_region: "Add Region",
    sample_timing_region: "region",
    sample_timing_note_count: "{n} detected notes",
    sample_timing_fixed_segment: "Fixed / non-stretched segment",
    sample_timing_stretch_segment: "Stretchable segment",
    sample_timing_alignment: "Alignment",
    sample_timing_start: "Region start",
    sample_timing_fixed_end: "Fixed segment end",
    sample_timing_end: "Region end",
    sample_timing_name: "Name / pronunciation",
    sample_timing_fixed_duration: "Fixed duration",
    sample_timing_active_region: "Use this region for clip stretching",
    sample_timing_saved: "Saved CSV sidecar and applied it to this clip.",
    sample_timing_detected: "Boundaries and notes were detected. Review and save them.",
    sample_timing_converting_oto: "Converting UTAU oto timing…",
    sample_timing_oto_result: "Converted {n} samples; {w} warnings.",
    melodyne_macro_title: "Correct Pitch Macro",
    melodyne_macro_selected_scope: "Selected note/time range",
    melodyne_macro_clip_scope: "Entire selected audio clip",
    melodyne_pitch_center: "Pitch center",
    melodyne_pitch_drift: "Pitch drift",
    melodyne_pitch_modulation: "Pitch modulation",
    melodyne_transition: "Transition",
    melodyne_game_model: "GAME analysis model",
    melodyne_game_large: "Large quality",
    melodyne_game_small: "Small performance",
    melodyne_game_large_hint: "Large is the default for finer note segmentation.",
    melodyne_game_small_hint: "Performance mode uses Small for faster analysis.",
    melodyne_macro_hint: "Drag a note vertically to transpose it; use the macro for natural correction.",
    melodyne_reset: "Reset",
    melodyne_apply: "Apply",
    melodyne_applying: "Applying…",
    melodyne_result: "Corrected {n} notes with {detector}.",
    melodyne_show_macro: "Pitch Macro",
    melodyne_wrench_title: "Note Tools",
    melodyne_note_lane: "Note selection",
    melodyne_segment_lane: "Sample segments",
    ...
    melodyne_game_alignment_hint: "GAME note starts are used as the default beat-alignment points.",
