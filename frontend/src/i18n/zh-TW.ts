...
export const zhTW = {
    ...
    stretch_hifigan_mel: "HiFiGAN 變 Hop Mel 拉伸",
    ...
    stretch_option_melodyne_hybrid: "Melodyne 混合（瞬態保護）",
    stretch_option_loop: "循環拉伸（元音/選區）",
    stretch_option_hifigan_mel_hop: "HiFiGAN 可變 Mel Hop 拉伸",
    melodyne_event_lane: "靜音 / 呼吸",
    audio_event_silence: "靜音",
    audio_event_breath: "呼吸",
    audio_event_none: "未偵測到靜音或呼吸事件",
    ...
    ctx_edit_sample_timing: "編輯採樣分段與音符…",
    sample_timing_title: "採樣分段與音符選區",
    sample_timing_description:
        "琥珀色為固定（不拉伸）段，青色為可拉伸段，粉色線為音符對齊點。時間均相對於來源音訊。",
    sample_timing_analyzing: "正在粗略辨識採樣邊界和音符…",
    sample_timing_redetect: "重新辨識",
    sample_timing_import_oto: "匯入 oto.ini",
    sample_timing_import_voicebank: "轉換整個 UTAU 音源庫",
    sample_timing_add_region: "新增選區",
    sample_timing_region: "選區",
    sample_timing_note_count: "已辨識 {n} 個音符",
    sample_timing_fixed_segment: "固定／不拉伸段",
    sample_timing_stretch_segment: "可拉伸段",
    sample_timing_alignment: "音符對齊點",
    sample_timing_start: "選區起點",
    sample_timing_fixed_end: "固定段終點",
    sample_timing_end: "選區終點",
    sample_timing_name: "名稱／發音",
    sample_timing_fixed_duration: "固定段持續時間",
    sample_timing_active_region: "使用此選區控制目前片段拉伸",
    sample_timing_saved: "CSV 標註已儲存並套用到目前片段。",
    sample_timing_detected: "已粗略辨識邊界與音符，請檢查後儲存。",
    sample_timing_converting_oto: "正在轉換 UTAU oto 標註…",
    sample_timing_oto_result: "已轉換 {n} 個採樣，產生 {w} 條警告。",

    melodyne_macro_title: "音高校正巨集",
    melodyne_macro_selected_scope: "目前選取的音符／時間範圍",
    melodyne_macro_clip_scope: "整個已選音訊片段",
    melodyne_pitch_center: "音高中心",
    melodyne_pitch_drift: "音高漂移",
    melodyne_pitch_modulation: "音高調制",
    melodyne_transition: "過渡時間",
    melodyne_game_model: "GAME 分析模型",
    melodyne_game_large: "高精度 Large",
    melodyne_game_small: "效能 Small",
    melodyne_game_large_hint: "預設使用 Large 模型，以取得更精細的音符分割。",
    melodyne_game_small_hint: "效能模式使用 Small 模型，分析速度更快。",
    melodyne_macro_hint: "垂直拖曳音符塊可移調；校正巨集用於保留自然起伏的整體修音。",
    melodyne_reset: "還原",
    melodyne_apply: "套用",
    melodyne_applying: "處理中…",
    melodyne_result: "已使用 {detector} 校正 {n} 個音符。",
    melodyne_show_macro: "校正巨集",
    melodyne_wrench_title: "音符工具",
    melodyne_note_lane: "音符選區",
    melodyne_segment_lane: "取樣分段",
    ...
    source_file_changed_modified_desc:
        '以下音訊檔案已在外部被修改。是否重新載入到工程中？',
    source_file_changed_deleted_desc:
        '以下音訊檔案已被移動或刪除。是否選擇替代檔案？',
    ...
    melodyne_import_title: '正在匯入 Melodyne 工程',
    melodyne_import_stage_open: '正在開啟工程',
    melodyne_import_stage_scan: '正在掃描工程容器',
    melodyne_import_stage_decompress: '正在解壓工程物件圖',
    melodyne_import_stage_parse: '正在解析工程物件圖',
    melodyne_import_stage_tracks: '正在讀取 Melodyne 軌道',
    melodyne_import_stage_media: '正在定位音訊素材',
    melodyne_import_stage_samples: '正在整理取樣分組',
    melodyne_import_stage_clips: '正在建立時間軸片段',
