export const koKR = {
    ...
    stretch_hifigan_mel: "HiFiGAN 가변 Hop Mel 스트레치",
    ...
    stretch_option_melodyne_hybrid: "Melodyne 하이브리드 (트랜지언트 보호)",
    stretch_option_loop: "루프 스트레치 (모음/선택 영역)",
    stretch_option_hifigan_mel_hop: "HiFiGAN 가변 Mel Hop 스트레치",
    melodyne_event_lane: "무음 / 호흡",
    audio_event_silence: "무음",
    audio_event_breath: "호흡",
    audio_event_none: "무음 또는 호흡 이벤트가 감지되지 않았습니다",
    ...
    ctx_edit_sample_timing: "샘플 구간과 음표 편집…",
    sample_timing_title: "샘플 구간 및 음표 영역",
    sample_timing_description:
        "황색은 고정(비신축) 구간, 청록색은 신축 구간, 분홍색 선은 음표 정렬점입니다. 시간은 원본 오디오 기준입니다.",
    sample_timing_analyzing: "경계와 음표 분석 중…",
    sample_timing_redetect: "다시 감지",
    sample_timing_import_oto: "oto.ini 가져오기",
    sample_timing_import_voicebank: "보이스뱅크 폴더 변환",
    sample_timing_add_region: "영역 추가",
    sample_timing_region: "영역",
    sample_timing_note_count: "감지된 음표 {n}개",
    sample_timing_fixed_segment: "고정／비신축 구간",
    sample_timing_stretch_segment: "신축 가능 구간",
    sample_timing_alignment: "정렬점",
    sample_timing_start: "영역 시작",
    sample_timing_fixed_end: "고정 구간 끝",
    sample_timing_end: "영역 끝",
    sample_timing_name: "이름／발음",
    sample_timing_fixed_duration: "고정 구간 길이",
    sample_timing_active_region: "이 영역을 클립 신축에 사용",
    sample_timing_saved: "CSV를 저장하고 클립에 적용했습니다.",
    sample_timing_detected: "경계와 음표를 감지했습니다. 확인 후 저장하세요.",
    sample_timing_converting_oto: "UTAU oto 변환 중…",
    sample_timing_oto_result: "샘플 {n}개 변환, 경고 {w}개.",
    ...
    melodyne_macro_title: "피치 보정 매크로",
    melodyne_macro_selected_scope: "선택한 음표／시간 범위",
    melodyne_macro_clip_scope: "선택한 오디오 클립 전체",
    melodyne_pitch_center: "피치 중심",
    melodyne_pitch_drift: "피치 드리프트",
    melodyne_pitch_modulation: "피치 모듈레이션",
    melodyne_transition: "전환",
    melodyne_game_model: "GAME 분석 모델",
    melodyne_game_large: "고정밀 Large",
    melodyne_game_small: "고성능 Small",
    melodyne_game_large_hint: "기본값은 더 정밀한 음표 분할을 위해 Large 모델을 사용합니다.",
    melodyne_game_small_hint: "성능 모드는 더 빠른 분석을 위해 Small 모델을 사용합니다.",
    melodyne_macro_hint: "음표를 세로로 드래그해 조옮김하고 매크로로 자연스러운 움직임을 유지하며 보정합니다.",
    melodyne_reset: "초기화",
    melodyne_apply: "적용",
    melodyne_applying: "적용 중…",
    melodyne_result: "{detector}(으)로 {n}개 음표를 보정했습니다.",
    melodyne_show_macro: "피치 매크로",
    melodyne_wrench_title: "음표 도구",
    melodyne_note_lane: "음표 선택",
    melodyne_segment_lane: "샘플 구간",
    ...
    melodyne_game_alignment_hint: "각 GAME 음표의 시작점을 기본 리듬 정렬점으로 사용합니다.",
