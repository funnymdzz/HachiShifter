export const jaJP = {
    ...
    stretch_hifigan_mel: "HiFiGAN 可変 Hop Mel ストレッチ",
    ...
    stretch_option_melodyne_hybrid: "Melodyne ハイブリッド（トランジェント保護）",
    stretch_option_loop: "ループストレッチ（母音/選択範囲）",
    stretch_option_hifigan_mel_hop: "HiFiGAN 可変 Mel Hop ストレッチ",
    melodyne_event_lane: "無音 / ブレス",
    audio_event_silence: "無音",
    audio_event_breath: "ブレス",
    audio_event_none: "無音またはブレスイベントは検出されませんでした",
    ...
    ctx_edit_sample_timing: "サンプル区間とノートを編集…",
    sample_timing_title: "サンプル区間とノート領域",
    sample_timing_description:
        "琥珀色は固定（非伸縮）区間、シアンは伸縮可能区間、ピンク線はノート整列点です。時間は元音声基準です。",
    sample_timing_analyzing: "境界とノートを解析中…",
    sample_timing_redetect: "再検出",
    sample_timing_import_oto: "oto.iniを読み込む",
    sample_timing_import_voicebank: "音源フォルダーを変換",
    sample_timing_add_region: "領域を追加",
    sample_timing_region: "領域",
    sample_timing_note_count: "検出ノート: {n}",
    sample_timing_fixed_segment: "固定／非伸縮区間",
    sample_timing_stretch_segment: "伸縮可能区間",
    sample_timing_alignment: "整列点",
    sample_timing_start: "領域開始",
    sample_timing_fixed_end: "固定区間終了",
    sample_timing_end: "領域終了",
    sample_timing_name: "名前／発音",
    sample_timing_fixed_duration: "固定区間長",
    sample_timing_active_region: "この領域をクリップ伸縮に使用",
    sample_timing_saved: "CSVを保存し、クリップに適用しました。",
    sample_timing_detected: "境界とノートを検出しました。確認後に保存してください。",
    sample_timing_converting_oto: "UTAU otoを変換中…",
    sample_timing_oto_result: "{n}サンプルを変換、警告{w}件。",

    melodyne_macro_title: "ピッチ補正マクロ",
    melodyne_macro_selected_scope: "選択したノート／時間範囲",
    melodyne_macro_clip_scope: "選択したオーディオクリップ全体",
    melodyne_pitch_center: "ピッチセンター",
    melodyne_pitch_drift: "ピッチドリフト",
    melodyne_pitch_modulation: "ピッチモジュレーション",
    melodyne_transition: "トランジション",
    melodyne_game_model: "GAME 解析モデル",
    melodyne_game_large: "高精度 Large",
    melodyne_game_small: "高速 Small",
    melodyne_game_large_hint: "既定では、より精密なノート分割を行う Large モデルを使用します。",
    melodyne_game_small_hint: "パフォーマンスモードでは高速な Small モデルを使用します。",
    melodyne_macro_hint: "ノートを上下にドラッグして移調し、マクロで自然な揺らぎを保ちながら補正します。",
    melodyne_reset: "リセット",
    melodyne_apply: "適用",
    melodyne_applying: "適用中…",
    melodyne_result: "{detector} で {n} 個のノートを補正しました。",
    melodyne_show_macro: "ピッチマクロ",
    melodyne_wrench_title: "ノートツール",
    melodyne_note_lane: "ノート選択",
    melodyne_segment_lane: "サンプル区間",
