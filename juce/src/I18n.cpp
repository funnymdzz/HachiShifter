...
const std::unordered_map<std::string, Row> strings {
    ...
    { "tool.connect.merge", { "合并", "合併", "結合", "병합", "Merge" } },
    { "tool.connect.glide", { "滑音分割", "滑音分割", "グライド分割", "글라이드 분할", "Glide Split" } },
    { "tool.connect.split", { "完全切断", "完全切斷", "完全切断", "완전 절단", "Full Cut" } },
    ...
    { "algo.stretch.nsfVariableMel", { "可变 Hop Mel 拉伸", "可變 Hop Mel 拉伸", "可変 Hop Mel ストレッチ", "가변 Hop Mel 스트레치", "Variable-Hop Mel" } },
